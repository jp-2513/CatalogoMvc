...
namespace CategoriasMvc.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<ActionResult<ProdutoViewModel>> CriarNovoProduto(ProdutoViewModel produtoVM)
        {
            ...
            {
                var result = await _produtoService.CriaProduto(produtoVM);
        ...
        {
            var result = await _produtoService.GetProdutoPorId(id);
        ...
        public async Task<ActionResult<ProdutoViewModel>> AtualizarProduto(int id, ProdutoViewModel produtoVM)
        {
            if (ModelState.IsValid)
            {
                var result = await _produtoService.AtualizaProduto(id, produtoVM);
        ...
        {
            var result = await _produtoService.DeletaProduto(id);
